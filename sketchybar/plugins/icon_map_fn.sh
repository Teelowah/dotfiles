...
# Maps app names to respective icons from sketchybar-app-font (Font Book)
function icon_map() {
  case "$1" in
  "Keynote" | "Keynote 讲演")
    icon_result=":keynote:"
...
icon_map "$1" # Passes name of app to function 

echo "$icon_result" # Returns corresponding app icon
