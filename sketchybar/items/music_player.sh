...
command -v 'menubar' 2>/dev/null 1>&2 || alias menubar="$CONFIG_DIR/menubar"

SCRIPT_MUSIC="export PATH=$PATH; $CONFIG_DIR/plugins/music_player/music_artwork.sh $ARTWORK_MARGIN $BAR_HEIGHT #SKETCHYBAR_MEDIASTREAM#"

SCRIPT_CLICK_MUSIC_ARTWORK="export PATH=$PATH;  media-control toggle-play-pause"

SCRIPT_MUSIC_TITLE="export PATH=$PATH; $CONFIG_DIR/plugins/music_player/music_title.sh"

SCRIPT_CLICK_MUSIC_TITLE="export PATH=$PATH; menubar -s \"Control Center,NowPlaying\""

SCRIPT_CENTER_SEP="export PATH=$PATH; $CONFIG_DIR/plugins/music_player/music-separator.sh"
